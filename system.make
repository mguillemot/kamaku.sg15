...
# C:\IGAM\svn_kimsufi\sg1_working\system.mhs
# The software specification of the system is in file :
# C:\IGAM\svn_kimsufi\sg1_working\system.mss
...
libyggdrasil_program: $(LIBYGGDRASIL_OUTPUT) 

$(LIBYGGDRASIL_OUTPUT) : $(LIBYGGDRASIL_SOURCES) $(LIBYGGDRASIL_HEADERS) $(LIBYGGDRASIL_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/libyggdrasil_compiler.opt
	@mkdir -p $(LIBYGGDRASIL_OUTPUT_DIR) 
	$(LIBYGGDRASIL_CC) $(LIBYGGDRASIL_CC_OPT) $(LIBYGGDRASIL_SOURCES) -o $(LIBYGGDRASIL_OUTPUT) \
	$(LIBYGGDRASIL_OTHER_CC_FLAGS) $(LIBYGGDRASIL_INCLUDES) $(LIBYGGDRASIL_LIBPATH) \
	$(LIBYGGDRASIL_CFLAGS) $(LIBYGGDRASIL_LFLAGS) 
	$(LIBYGGDRASIL_CC_SIZE) $(LIBYGGDRASIL_OUTPUT) 

libyggdrasil_programclean:
	rm -f $(LIBYGGDRASIL_OUTPUT) 
...
test_son_program: $(TEST_SON_OUTPUT) 

$(TEST_SON_OUTPUT) : $(TEST_SON_SOURCES) $(TEST_SON_HEADERS) $(TEST_SON_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/test_son_compiler.opt
	@mkdir -p $(TEST_SON_OUTPUT_DIR) 
	$(TEST_SON_CC) $(TEST_SON_CC_OPT) $(TEST_SON_SOURCES) -o $(TEST_SON_OUTPUT) \
	$(TEST_SON_OTHER_CC_FLAGS) $(TEST_SON_INCLUDES) $(TEST_SON_LIBPATH) \
	$(TEST_SON_CFLAGS) $(TEST_SON_LFLAGS) 
	$(TEST_SON_CC_SIZE) $(TEST_SON_OUTPUT) 

test_son_programclean:
	rm -f $(TEST_SON_OUTPUT) 

#################################################################
# SOFTWARE APPLICATION TEST_UART
#################################################################

test_uart_program: $(TEST_UART_OUTPUT) 

$(TEST_UART_OUTPUT) : $(TEST_UART_SOURCES) $(TEST_UART_HEADERS) $(TEST_UART_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/test_uart_compiler.opt
	@mkdir -p $(TEST_UART_OUTPUT_DIR) 
	$(TEST_UART_CC) $(TEST_UART_CC_OPT) $(TEST_UART_SOURCES) -o $(TEST_UART_OUTPUT) \
	$(TEST_UART_OTHER_CC_FLAGS) $(TEST_UART_INCLUDES) $(TEST_UART_LIBPATH) \
	$(TEST_UART_CFLAGS) $(TEST_UART_LFLAGS) 
	$(TEST_UART_CC_SIZE) $(TEST_UART_OUTPUT) 

test_uart_programclean:
	rm -f $(TEST_UART_OUTPUT) 

#################################################################
# SOFTWARE APPLICATION TEST_DMA
#################################################################

test_dma_program: $(TEST_DMA_OUTPUT) 

$(TEST_DMA_OUTPUT) : $(TEST_DMA_SOURCES) $(TEST_DMA_HEADERS) $(TEST_DMA_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/test_dma_compiler.opt
	@mkdir -p $(TEST_DMA_OUTPUT_DIR) 
	$(TEST_DMA_CC) $(TEST_DMA_CC_OPT) $(TEST_DMA_SOURCES) -o $(TEST_DMA_OUTPUT) \
	$(TEST_DMA_OTHER_CC_FLAGS) $(TEST_DMA_INCLUDES) $(TEST_DMA_LIBPATH) \
	$(TEST_DMA_CFLAGS) $(TEST_DMA_LFLAGS) 
	$(TEST_DMA_CC_SIZE) $(TEST_DMA_OUTPUT) 

test_dma_programclean:
	rm -f $(TEST_DMA_OUTPUT) 

...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = isuperdma
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = isuperdma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = isprite
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = isprite_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ivga
 PARAMETER DRIVER_VER = 2.00.a
 PARAMETER HW_INSTANCE = ivga_0
END
